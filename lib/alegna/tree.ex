defmodule Alegna.Tree do
  ...
  @type t :: %Tree{size: tsize, root: tnode | nil}
  ...
  defmodule Leaf do
    ...
    @type t :: %Leaf{height: Tree.theight, hash: Tree.thash}
  end
  ...
  @spec add_value(tsize, tnode, thash) :: tnode
  ...
  defp max_size(height), do: trunc(:math.pow(2, height + 1)) - 1
